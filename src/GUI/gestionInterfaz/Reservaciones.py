...
class Reservaciones(Frame):
    ...
    def _inicializarFecha(self):
        ...
        labelFC = Label(frameEntrada, text="Elige una opción:",
                        bg=BACKGROUND_CONTENEDOR, font=FONT2, fg=FG)
        labelFC.grid(row=0, column=0, padx=10, pady=10, sticky="w")


        # Crear un combo box (menú desplegable)
        opciones = ["Opción 1", "Opción 2", "Opción 3"]
        combo = Frame.Combobox(frameEntrada, values=opciones)
        combo.pack(pady=10)
