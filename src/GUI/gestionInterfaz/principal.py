...
class Principal(Toplevel):
    ...
    def __init__(self, padre):
        ...
        for F in (Instrucciones,Reporte,Compra,ConsultarPlatoPreferido, inventarioapp, ConsultarPlatoRecomendado, Fechasreserv, CancelarReserv, ModificarRes, AtencionCliente, OpcionesDePedidos ):
